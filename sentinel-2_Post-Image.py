...
<<<<<<< HEAD
            compress='LZW', # Compression changed to LZW
=======
            compress='deflate', # Compression to reduce Memory and Size of file
>>>>>>> f198252af1a6c4468d4f1660655b24698b6ef517
            predictor=2,  # Predictor for horizontal differencing
            tiled=True  # Enable tiling for more efficient compression
        ) as dst:
...
def process_bands(input_folder, output_folder):
    ...
    for jp2_file in jp2_files:
        ...
        if 'B01' in jp2_file:
            band_paths['B01'] = output_path
        elif 'B02' in jp2_file:
            band_paths['B02'] = output_path
        elif 'B03' in jp2_file:
        ...
        elif 'B11' in jp2_file:
            band_paths['B11'] = output_path
...
<<<<<<< HEAD
                'COMPRESS=LZW',  # Compression changed to LZW
=======
                'COMPRESS=DEFLATE',  # More efficient compression
>>>>>>> f198252af1a6c4468d4f1660655b24698b6ef517
                'TILED=YES',
