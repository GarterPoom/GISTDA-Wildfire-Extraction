    ...
    try:
        ...
        for jp2_file in jp2_files:
            ...
            if resample_image(str(jp2_file), str(output_path)):
                ...
                # Mapping Sentinel-2 bands to the file names based on expected band identifiers
                band_map = {
        ...
        # Extracting the tile date from the JP2 filenames (example: 'S2A_20201201T103031_20201201T103459_T32TQM_B01.jp2')
...
def main():
    ...
    root_folder = Path('Classified Image')  # Adjust the input folder to point to your Sentinel-2 L1C data
    output_folder = Path('Raster Classified')
    output_folder.mkdir(parents=True, exist_ok=True)
