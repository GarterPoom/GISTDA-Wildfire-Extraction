...
def create_polygon_shapefile_from_burnt_areas(tif_file_path, output_folder):
    ...
    # Reproject the geometries to the UTM CRS
...
if __name__ == "__main__":
    root_folder = r'Raster_Classified Output'  # Path to the root folder where the TIFF is located
    output_folder = r'Shape Polygon'  # Path to the folder where the shapefile will be saved
