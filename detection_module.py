...
from wildfire_classified import main as wildfire # Import Main module from wildfire_classified
from wildfire_polygon import main as polygon # Import Main module from wildfire_polygon
